...
<div class="cards">
    <div class="card">
        ...
        <p>
            ...
            $disponiblesQuery = "SELECT COUNT(*) AS disponibles FROM aerohockey WHERE estudiante = ''";
    ...
    <div class="card">
        ...
        <p>
            ...
            $bloqueadasQuery = "SELECT COUNT(*) AS bloqueadas FROM aerohockey WHERE estado = 'inactivo'";
...
<table>
    ...
    <tbody>
        <?php
        // Consulta para obtener todos los registros de la tabla aerohockey
        $table = 'aerohockey';
