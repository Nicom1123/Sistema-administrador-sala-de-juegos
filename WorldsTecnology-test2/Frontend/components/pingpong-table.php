...
<div class="cards">
    <div class="card">
        ...
        <p>
            ...
            $disponiblesQuery = "SELECT COUNT(*) AS disponibles FROM PingPong WHERE estado = 'activo' AND estudiante = ''";
    ...
    <div class="card">
        ...
        <p>
            ...
            $bloqueadasQuery = "SELECT COUNT(*) AS bloqueadas FROM PingPong WHERE estado = 'inactivo'";
...
<table>
    ...
    <tbody>
        <?php
        $table = 'PingPong'; // Define la tabla correspondiente
