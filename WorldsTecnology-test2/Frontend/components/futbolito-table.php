...
<div class="cards">
    <div class="card">
        ...
        <p>
            ...
            $disponiblesQuery = "SELECT COUNT(*) AS disponibles FROM futbolito WHERE estudiante = '' AND estado='activo'";
    ...
    <div class="card">
        ...
        <p>
            ...
            $bloqueadasQuery = "SELECT COUNT(*) AS bloqueadas FROM futbolito WHERE estado = 'inactivo'";
...
<table>
    ...
    <tbody>
        <?php
        $table = 'futbolito'; // Define la tabla correspondiente
