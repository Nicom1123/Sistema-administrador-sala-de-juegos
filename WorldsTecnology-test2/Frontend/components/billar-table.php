...
<div class="cards">
    <div class="card">
        ...
        <p>
            <?php
            // Consulta para obtener el conteo de mesas disponibles
            $disponiblesQuery = "SELECT COUNT(*) AS disponibles FROM billar WHERE estudiante = '' AND estado='activo'";
    ...
    <div class="card">
        ...
        <p>
            <?php
            // Consulta para obtener el conteo de mesas bloqueadas
            $bloqueadasQuery = "SELECT COUNT(*) AS bloqueadas FROM billar WHERE estado = 'inactivo'";
...
<table>
    ...
    <tbody>
        <?php
        // Consulta para obtener todos los registros de la tabla billar
        $table = 'billar';
